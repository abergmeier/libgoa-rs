...
glib_wrapper! {
    pub struct Calendar(Interface<goa_sys::GoaCalendar>);

    match fn {
        get_type => || goa_sys::goa_calendar_get_type(),
    }
}

impl Calendar {
    //pub fn interface_info() -> /*Ignored*/Option<gio::DBusInterfaceInfo> {
    //    unsafe { TODO: call goa_sys:goa_calendar_interface_info() }
    //}

    //pub fn override_properties(klass: /*Ignored*/&mut glib::ObjectClass, property_id_begin: u32) -> u32 {
    //    unsafe { TODO: call goa_sys:goa_calendar_override_properties() }
    //}
}
...
impl<O: IsA<Calendar>> CalendarExt for O {
    ...
    fn dup_uri(&self) -> Option<GString> {
        unsafe {
            from_glib_full(goa_sys::goa_calendar_dup_uri(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_accept_ssl_errors(&self) -> bool {
        unsafe {
            from_glib(goa_sys::goa_calendar_get_accept_ssl_errors(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_uri(&self) -> Option<GString> {
        unsafe {
            from_glib_none(goa_sys::goa_calendar_get_uri(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_accept_ssl_errors(&self, value: bool) {
        unsafe {
            goa_sys::goa_calendar_set_accept_ssl_errors(self.as_ref().to_glib_none().0, value.to_glib());
        }
    }
    ...
    fn set_uri(&self, value: &str) {
        unsafe {
            goa_sys::goa_calendar_set_uri(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    #[cfg(any(feature = "v3_8", feature = "dox"))]
    fn connect_property_accept_ssl_errors_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accept_ssl_errors_trampoline<P, F: Fn(&P) + 'static>(this: *mut goa_sys::GoaCalendar, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
    ...
    #[cfg(any(feature = "v3_8", feature = "dox"))]
    fn connect_property_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_uri_trampoline<P, F: Fn(&P) + 'static>(this: *mut goa_sys::GoaCalendar, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<Calendar>
        {
            let f: &F = &*(f as *const F);
            f(&Calendar::from_glib_borrow(this).unsafe_cast())
